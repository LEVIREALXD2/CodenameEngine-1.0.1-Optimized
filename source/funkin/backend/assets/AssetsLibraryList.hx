...
class AssetsLibraryList extends AssetLibrary {
	...
	public function new(?base:AssetLibrary) {
		...
		__defaultLibraries.push(ModsFolder.loadLibraryFromFolder('assets', #if android StorageUtil.getModsPath() + #elseif (!android && mobile) StorageUtil.getStorageDirectory() + #end 'assets/', true, SOURCE));
		#end
